...
const shoulders = [
  {
    ...
    imgUrl: "/images/seated-dumbbell-press.jpg",
    description:
  ...
  },
  {
    ...
    imgUrl: "/images/arnold-press.jpg",
    description:
  ...
  },
  {
    ...
    imgUrl: "/images/lateral-raises.jpg",
    description:
  ...
  },
  {
    ...
    imgUrl: "/images/front-dumbbell-raises.jpg",
    description:
  ...
  },
  {
    ...
    imgUrl: "/images/barbell-shrugs.jpg",
    description:
          ...
          {shoulders?.map((exercise) => (
            ...
            >
              <img
                ...
                onError={(e) => (e.target.src = "https://via.placeholder.com/300x200.png?text=Image+Not+Found")} // Fallback image
              />
              <div className="p-5">
