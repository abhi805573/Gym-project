        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6">
            <div className="w-full md:w-1/3 px-4 text-center">
              <div className="relative flex flex-col h-full min-w-0 break-words bg-white w-full shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  GymFlow is your destination for achieving the fitness
            ...
            <div className="w-full md:w-1/3 px-4 text-center">
              <div className="relative flex flex-col h-full min-w-0 break-words bg-white w-full shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  <p className="mt-2 mb-4 text-gray-600">
                    More than just a workout, Fit is a community. Find
              ...
              <div className="relative flex flex-col h-full min-w-0 break-words bg-white w-full shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  <p className="mt-2 mb-4 text-gray-600">
                    ...
                    your energy, or find a workout you actually enjoy, GymFlow
                    has you covered. We offer the complete fitness package:
                    specialized equipment, personalized training programs.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    At GymFlow, we are committed to providing top-notch
